 ...
 * @author manan
 */
public class tvpop extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             Document doc;
            try{
            doc=Jsoup.connect("https://www.imdb.com/chart/tvmeter/?ref_=nv_tvv_mptv").timeout(6000).get();
            Elements body = doc.select("tbody.lister-list");
            int x=1;
            out.print("<h1><b><u><center>Most Popular TV Shows</h1></b></u>");
               ...
               for(Element e:body.select("tr"))
                {
                    ...
                    out.print("  <h2><a href='redirect'>"+x+" "+title +"</a></h2>  ");
